...
def start_docker_sandbox(host_to_deploy, uid, sid, wid, wname, sandbox_image_name):
    ...
    if success:
        try:
            ...
            client.containers.run(sandbox_image_name, init=True, detach=True, ports={"8080/tcp": None}, ulimits=ulimit_list, auto_remove=True, name=sid, environment=env_vars, extra_hosts={host_to_deploy[0]:host_to_deploy[1]}, log_config=lc, privileged=True)
